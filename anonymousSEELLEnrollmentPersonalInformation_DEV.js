...
function toggleBusinessIsHomeAddress() {
    ...
    if (businessIsHome) {
        ...
        // Set placeholder values to satisfy field requirement before workflow executes
        $("#ndph_street1business").val("Placeholder");
        $("#ndph_mequestion11").val("d9c27733-613f-ea11-a813-000d3a851ff7");    // Philippines
